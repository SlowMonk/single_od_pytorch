...
#from datasets import BalloonDataset
...
def make_true_boxes_new_scale(df, image_num,input_size):
    ...
    #print('make_true_boxes_new_scale')
    #print('x->{},y->{},w->{},h->{}, input_size->{}, original_>{}'.format(x,y,w,h,input_size,original_size))
    ...
    for i in range(len(x)):
        ...
        new_w  = w[i] * new_scale
        new_h = h[i] * new_scale
        #print('x[i]->', x[i],'to->',x[i] * new_scale)
